...
class Utilities {
    ...
    static func styleTextField(_ textfield:UITextField) {
        ...
        bottomLine.backgroundColor = UIColor.init(red: 10/255, green: 10/255, blue: 10/255, alpha: 1).cgColor
    ...
    static func styleFilledButton(_ button:UIButton) {
        ...
        button.backgroundColor = UIColor.init(red: 10/255, green: 10/255, blue: 10/255, alpha: 1)
